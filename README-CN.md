...
感谢您对阿里云 Terraform Module 的关注，由于[阿里云SCDN已停止新购](https://www.aliyun.com/product/scdn)，即日起，本 Module 将停止维护并会在将来正式下线。推荐您使用 [terraform-alicloud-dcdn
](https://github.com/alibabacloud-automation/terraform-alicloud-dcdn) 作为替代方案。更多丰富的 Module 可在 [阿里云 Terraform Module](https://registry.terraform.io/browse/modules?provider=alibaba) 中搜索获取。
